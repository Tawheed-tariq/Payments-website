    ...
    ${styles.flexCenter} flex-col relative`}>
      ...
      <div className="w-full flex justify-between items-center
       md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
        ...
        <h1 className={styles.heading2} data-aos="fade-right">What people are 
        ...
        <div className="w-full md:mt-0 mt-6">
          <p className={`${styles.paragraph} text-left max-w-[450px]`} data-aos="fade-left">Everything you need to accept card 
